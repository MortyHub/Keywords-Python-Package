...
Welcome to ``KeywordsPlus`` contributor's guide.
...
If you experience bugs or general issues with ``KeywordsPlus``, please have a look
...
You can help improve ``KeywordsPlus`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``KeywordsPlus`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``KeywordsPlus``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n KeywordsPlus python=3 six virtualenv pytest pytest-cov
    conda activate KeywordsPlus
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/KeywordsPlus.git
    cd KeywordsPlus
...
#. Install |pre-commit|_::
   ...
   ``KeywordsPlus`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/KeywordsPlus
.. _issue tracker: https://github.com/<USERNAME>/KeywordsPlus/issues
.. <-- end -->
